...
try:
    dataset = pd.read_csv('..\\DecisionTree_Classification\\Social_Network_Ads.csv')
except:
    dataset = pd.read_csv('UdemyMLAZ\\DecisionTree_Classification\\Social_Network_Ads.csv')
