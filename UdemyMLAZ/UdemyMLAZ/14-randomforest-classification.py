...
try:
    dataset = pd.read_csv('..\\RandomForest_Classification\\Social_Network_Ads.csv')
except:
    dataset = pd.read_csv('UdemyMLAZ\\RandomForest_Classification\\Social_Network_Ads.csv')
